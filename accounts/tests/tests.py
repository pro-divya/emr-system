...
from accounts.models import User, ClientUser, GeneralPracticeUser, MedidataUser
from accounts.models import CLIENT_USER, GENERAL_PRACTICE_USER, MEDIDATA_USER
