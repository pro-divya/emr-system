# Generated by Django 2.1 on 2018-10-19 10:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receive_email', models.EmailField(blank=True, max_length=255, null=True)),
                ('gp_name', models.CharField(max_length=255)),
                ('primary_care', models.CharField(choices=[('EW', 'EMIS-Web'), ('EP', 'EMIS-PCS'), ('EL', 'EMIS-LV'), ('ST', 'Systml'), ('VT', 'Vision Three'), ('VA', 'Vision Anywhere'), ('MT', 'Microtest'), ('OT', 'Other')], max_length=2)),
