...
class Instruction(TimeStampedModel, models.Model):
    ...
    gp_earns = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    medi_earns = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
