...
class Instruction(TimeStampedModel, models.Model):
    ...
    gp_user = models.ForeignKey(GeneralPracticeUser, on_delete=models.CASCADE, verbose_name='GP Allocated')
    ...
    status = models.IntegerField(choices=INSTRUCTION_STATUS_CHOICES)
    ...
    def __str__(self):
        return self.client_user.user.first_name + "::" + self.gp_user.user.first_name + "::" + self.patient.user.first_name
