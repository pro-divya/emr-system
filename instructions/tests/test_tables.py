...
class TestRenderTables( TestCase ):
    ...
    def test_render( self ):
        ...
        resultHTMLStr = str( response.content )
        ...
        self.assertInHTML( expected_client_name, resultHTMLStr )
        self.assertInHTML( expected_instructions_type, resultHTMLStr )
        self.assertInHTML( expected_patient_name, resultHTMLStr )
        self.assertInHTML( expected_gp_allocated, resultHTMLStr )
        self.assertInHTML( expected_cost, resultHTMLStr )
        self.assertInHTML( expected_created, resultHTMLStr )
        self.assertInHTML( expected_status, resultHTMLStr )